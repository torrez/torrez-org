---
title: Farked
date: 2004-10-25 00:00:00 -07:00
categories:
- Web/Tech
---

<a href="http://torrez.typepad.com/photos/uncategorized/little_traffic_spike.png" onclick="window.open(this.href, '_blank', 'width=491,height=218,scrollbars=no,resizable=no,toolbar=no,directories=no,location=no,menubar=no,status=no,left=0,top=0'); return false"><img alt="Little_traffic_spike" title="Little_traffic_spike" src="http://notes.torrez.org/images/little_traffic_spike.png" width="100" height="44" border="0" style="float: right; margin: 0px 0px 5px 5px;" /></a>
<p>
